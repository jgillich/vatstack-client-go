...
// checks if the HitValidations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HitValidations{}

// HitValidations struct for HitValidations
type HitValidations struct {
	// Included validations in the plan you’re subscribed to.
	Capacity *int32 `json:"capacity,omitempty"`
	// Validations created during the running month. Additional requests beyond `capacity` will be charged according to the plan you’re subscribed to.
...
func (o HitValidations) MarshalJSON() ([]byte, error) {
...
func (o HitValidations) ToMap() (map[string]interface{}, error) {
...
type NullableHitValidations struct {
	value *HitValidations
	isSet bool
}

func (v NullableHitValidations) Get() *HitValidations {
	return v.value
}

func (v *NullableHitValidations) Set(val *HitValidations) {
	v.value = val
	v.isSet = true
}

func (v NullableHitValidations) IsSet() bool {
	return v.isSet
}

func (v *NullableHitValidations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHitValidations(val *HitValidations) *NullableHitValidations {
	return &NullableHitValidations{value: val, isSet: true}
}

func (v NullableHitValidations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHitValidations) UnmarshalJSON(src []byte) error {
	v.isSet = true
